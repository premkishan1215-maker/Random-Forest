...
"[project]/src/app/dashboard/stage2/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AnimatedTree = ({ depth })=>{
    ...
    const expansionFactor = 1.8 - depth * 0.05;
    const renderNode = (level, cx, cy, key)=>{
        ...
        if (level < depth) {
            children.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                ...
                fileName: "[project]/src/app/dashboard/stage2/page.tsx",
                lineNumber: 29,
                columnNumber: 27
            }, this));
...
function Stage2Page() {
    _s();
    const { audience, parameters, setParameters } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$dashboard$2d$state$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardState"])();
...
_s(Stage2Page, "rwgdBubiLs/xMxcWDyT7f/4QDP8=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "Stage2Page");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_5a18a175._.js.map